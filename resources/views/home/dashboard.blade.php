    ...
    <div id="admin-page-wrapper" class="container-full">
        <div class="sidebar">
            <div id="sidebar-collapse" class="sidebar-nav navbar-collapse">
                <ul class="nav">
                    <li class="active"><a href="{{ route('home.dashboard') }}"><span class="fa fa-dashboard"></span> Dashboard</a></li>
                    <li><a href="{{ route('home.news') }}"><span class="fa fa-newspaper-o"></span> Manage News</a></li>
                </ul>
            </div>
            <!-- /.sidebar-collapse -->
        </div>
